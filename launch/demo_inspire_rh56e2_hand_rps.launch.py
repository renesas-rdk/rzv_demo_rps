...
def launch_setup(context, *args, **kwargs):
    """
    Launch camera-based RPS detection with Inspire RH56E2 hand control.

    Pipeline:
    camera -> object detection -> rps game controller -> ros2_control position controller
      -> joint_state_broadcaster -> urdf visualization
    ...
    - Hand gesture interpreter publishes /inspire_rh56e2_hand_joint_position_controller/commands
